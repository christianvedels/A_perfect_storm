...
%Is it relevant to study trade dynamics back then? \cite{FedericoSchulzeVolckart2021} demonstrates how some important important markets where integrated in the 15th century - much before the period studied here.

%\cite{Juhasz2018} demonstrates how French spinning markets faced British competition, (and how this in turn meant that they benefitted from infant-industry-type effects in the Napoleonic Blockade).

% \cite{Redding2008} demonstrates how market access changes account for the development after German reunification, and \cite{Ahlfeldt2015} studies the same for the case of urban reallocation in Berlin. 
...
%The immediate effect is a bit of an environmental disaster, where a few years of very high fish yields - right after the 1825 breach - were replaced by starvation until the economic benefit of trade was realized, and until the locals started adapting to fishing. 
...
%  \parbox{0.7\textwidth}{
%  \caption*{\footnotesize \textit{Notes:} Causal chain as a pseudo-DAG from the breach of the Agger Isthmus to the observed population increase.}
%}
%\end{center}
%\end{figure}
