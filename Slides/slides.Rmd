...
![Nightlight](Figures/The_earth_at_night_greyscale.png)
...
- Geography plays a role (which is smaller than instituions) (Ketterer and Rodŕıguez-Pose, 2018)
- .red123[**Important to verify in an age of climate change**]
]
...
- .green123[**'Human' time scale missing**]
]
